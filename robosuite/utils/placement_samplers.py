...
class UniformRandomSampler(ObjectPositionSampler):
    ...
    def sample(self, fixtures=None, reference=None, on_top=True):
        ...
        for obj in self.mujoco_objects:
            ...
            success = False
            #print(obj.name, on_top, base_offset, bottom_offset)
            for i in range(5000):  # 5000 retries
                ...
                #print("sample idx", i, "z_offset", self.z_offset, "base_offset", base_offset[2], "bottom offset", bottom_offset[-1])
                if on_top:
                ...
                if location_valid:
                    ...
                    #print("sample success!", obj.name, pos)
...
class UniformFixSampler(UniformRandomSampler):
    def _sample_x(self, object_horizontal_radius):
        """
        Samples the x location for a given object
    ...
    def sample(self, fixtures=None, reference=None, on_top=True):
        ...
        for obj in self.mujoco_objects:
            ...
            if on_top:
                object_z -= bottom_offset[-1]
            #print("x, y, z", object_x, object_y, object_z, horizontal_radius)
...
class SequentialCompositeSampler(ObjectPositionSampler):
    ...
    def sample(self, fixtures=None, reference=None, on_top=True):
        ...
        for sampler, s_args in zip(self.samplers.values(), self.sample_args.values()):
            ...
            #print("new placement", new_placements)
            # Update placements
