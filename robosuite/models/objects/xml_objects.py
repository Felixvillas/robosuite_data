...
#     def __init__(self, name):
#         super().__init__(
#             xml_path_completion("objects/round-nut-visual.xml"),
#             name=name,
#             joints=None,
#             obj_type="visual",
#             duplicate_collision_geoms=True,
...
#     def __init__(self, name):
#         super().__init__(
#             xml_path_completion("objects/square-nut-visual.xml"),
#             name=name,
#             joints=None,
#             obj_type="visual",
#             duplicate_collision_geoms=True,
#         )
# class SBoxVisualObject(MujocoXMLObject):
#     """
#     Visual fiducial of milk carton (used in PickPlace).
...
#     def __init__(self, name):
#         super().__init__(
#             xml_path_completion("objects/sbox-visual.xml"),
#             name=name,
#             joints=None,
#             obj_type="visual",
#             duplicate_collision_geoms=True,
...
# class XBoxVisualObject(MujocoXMLObject):
#     """
#     Visual fiducial of milk carton (used in PickPlace).
...
#     def __init__(self, name):
#         super().__init__(
#             xml_path_completion("objects/xbox-visual.xml"),
#             name=name,
#             joints=None,
#             obj_type="visual",
#             duplicate_collision_geoms=True,
...
#         xml_path = "objects/drawer/drawer_body.xml"
#         super().__init__(
...
class SunmaoObject(MujocoXMLObject):
    """
    Square nut object (used in NutAssembly)
    """

    def __init__(self, name, sunmao_type=2, up=True, m = "b"):
        self.sunmao_type = sunmao_type
        self.up = up
        self.m = m
        if sunmao_type == 2:
            path = "objects/jimu2.xml" if up else "objects/jimu22.xml"
        elif sunmao_type == 3:
            path = "objects/jimu3.xml" if up else "objects/jimu33.xml"
        elif sunmao_type == 4:
            if m == "b":
                path = "objects/jimu4.xml" if up else "objects/jimu44.xml"
            else:
                path = "objects/jimu4s.xml" if up else "objects/jimu44s.xml"
        elif sunmao_type == 5:
            if m == "b":
                path = "objects/jimu5.xml" if up else "objects/jimu55.xml"
            else:
                path = "objects/jimu5s.xml" if up else "objects/jimu55s.xml"
        else:
            raise NotImplementedError

        super().__init__(
            xml_path_completion(path),
            name=name,
            joints=[dict(type="free", damping="0.0005")],
            obj_type="all",
            duplicate_collision_geoms=True,
        )
class JimuObject(MujocoXMLObject):
    """
    Jimu object
    """

    def __init__(self, name, jimu_type):
        self.sunmao_type = jimu_type
        path = "objects/new_jimu/"+jimu_type+"/"+jimu_type+".xml"
        super().__init__(
            xml_path_completion(path),
            name=name,
            joints=[dict(type="free", damping="0.0005")],
...
class JimuVisualObject(MujocoXMLObject):
    """
    Visual fiducial of jimu.
    """

    def __init__(self, name, jimu_type):
        self.sunmao_type = jimu_type
        path = "objects/new_jimu/"+jimu_type+"/"+jimu_type+"_visual.xml"
        super().__init__(
            xml_path_completion(path),
            name=name,
            joints=None,
